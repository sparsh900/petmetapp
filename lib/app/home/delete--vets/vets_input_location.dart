...
class InputLocationState extends State<InputLocation> {
  ...
  Future<void> _showPrediction() async {
    ...
    GoogleMapsPlaces _places = new GoogleMapsPlaces(apiKey: 'AIzaSyBhcoax9k-GeiyCxaNvtTfVK2oFOxgdQrw');
...
//              ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Colors.black26, spreadRadius: 0, offset: Offset(1, 3), blurRadius: 4)],
            ),
            child: ListTile(
  ...
  void submitLocation(BuildContext context) {
    if (_markerPoint != null) {
      GeoFirePoint point = geo.point(latitude: _markerPoint.latitude, longitude: _markerPoint.longitude);
      Map<String, dynamic> locationData = {'latitude': _markerPoint.latitude, 'longitude': _markerPoint.longitude, 'address': _markerLocation};
      print("User selected new address which will be returned to previous page on stack" + locationData['address']);
