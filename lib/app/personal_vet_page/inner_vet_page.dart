...
import 'package:petmet_app/app/personal_vet_page/book_appointment_button.dart';
import 'package:petmet_app/main.dart';
import 'package:petmet_app/services/database.dart';

class InnerVetPage extends StatefulWidget {
  InnerVetPage({@required this.vetData, @required this.database,@required this.pet});
  final Vet vetData;
  final Database database;
  final Pet pet;
  @override
  InnerVetPageState createState() => InnerVetPageState();
}

class InnerVetPageState extends State<InnerVetPage> {
