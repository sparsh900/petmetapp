...
class AdoptionInputLocation extends StatefulWidget {
  @override
  State<AdoptionInputLocation> createState() => AdoptionInputLocationState();
}

class AdoptionInputLocationState extends State<AdoptionInputLocation> {
